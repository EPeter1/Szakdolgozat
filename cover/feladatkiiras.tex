...
Erdélyi Péter (JH3V7T) programtervező informatikus jelölt részére.

\bigskip
\noindent\textbf{A szakdolgozat tárgyköre:} Ipari automatizálás, grafikus felületek

\bigskip
\noindent\textbf{A szakdolgozat címe:} Grafikus IDE fejlesztése HMI felületek kialakításához
...
\emph{A HMI (Human-Machine Interface) felületek fejlesztése egy, az ipari automatizálásban gyakran előforduló probléma. A dolgozat célja egy olyan keretrendszer létrehozása, amely igyekszik hatékonyabbá, kényelmesebbé tenni ezek kialakítását, tesztelését.
A keretrendszernek lehetőséget kell adnia a különféle szenzorok (mint inputok) és aktuátorok (mint outputok) használatára grafikus szerkesztőeszköz segítségével. A bonyolultabb alkalmazáslogika definiálása egy beépített szkriptnyelv használatával történne.}

\medskip

\vfill

\noindent\textbf{Témavezető:} Lajos Sándor (mesteroktató, intézeti tanszékvezető)

% \noindent\textbf{Konzulens(ek):} (akkor kötelezõ, ha a témavezetõ nem valamelyik matematikai tanszékrõl való; de persze lehet egyébként is)\newline

\bigskip
\noindent\textbf{A feladat kiadásának ideje:} 2025. október 01.
